bits 16
    ...
    jmp __NOT_IMPLEMENTED__       ; os_move_cursor            ; 0006h
    jmp os_clear_screen           ; 0009h
    jmp __NOT_IMPLEMENTED__       ; os_print_horiz_line       ; 000Ch
    jmp os_print_newline          ; 000Fh
    jmp os_wait_for_key           ; 0012h
    jmp os_check_for_key          ; 0015h
    jmp os_int_to_string          ; 0018h
    jmp __NOT_IMPLEMENTED__       ; os_speaker_tone           ; 001Bh
    jmp __NOT_IMPLEMENTED__       ; os_speaker_off            ; 001Eh
    jmp os_load_file              ; 0021h
    jmp __NOT_IMPLEMENTED__       ; os_pause                  ; 0024h
    jmp __NOT_IMPLEMENTED__       ; os_fatal_error            ; 0027h
    jmp __NOT_IMPLEMENTED__       ; os_draw_background        ; 002Ah
    ...
    jmp __NOT_IMPLEMENTED__       ; os_dialog_box             ; 003Ch
    ...
    jmp __NOT_IMPLEMENTED__       ; os_get_api_version        ; 0057h
    jmp __NOT_IMPLEMENTED__       ; os_file_selector          ; 005Ah
    jmp os_get_date_string        ; 005Dh
    jmp __NOT_IMPLEMENTED__       ; os_send_via_serial        ; 0060h
    jmp __NOT_IMPLEMENTED__       ; os_get_via_serial         ; 0063h
    jmp os_find_char_in_string    ; 0066h
    jmp __NOT_IMPLEMENTED__       ; os_get_cursor_pos         ; 0069h
    jmp os_print_space            ; 006Ch
    jmp __NOT_IMPLEMENTED__       ; os_dump_string            ; 006Fh
    ...
    jmp __NOT_IMPLEMENTED__       ; os_long_int_negate        ; 0081h
    jmp os_set_time_fmt           ; 0084h
    jmp os_set_date_fmt           ; 0087h
    jmp __NOT_IMPLEMENTED__       ; os_show_cursor            ; 008Ah
    jmp __NOT_IMPLEMENTED__       ; os_hide_cursor            ; 008Dh
    ...
    jmp __NOT_IMPLEMENTED__       ; os_input_dialog           ; 00A8h
    jmp __NOT_IMPLEMENTED__       ; os_list_dialog            ; 00ABh
    jmp os_string_reverse         ; 00AEh
    jmp os_string_to_int          ; 00B1h
    jmp __NOT_IMPLEMENTED__       ; os_draw_block             ; 00B4h
    jmp __NOT_IMPLEMENTED__       ; os_get_random             ; 00B7h
    jmp os_string_charchange      ; 00BAh
    jmp __NOT_IMPLEMENTED__       ; os_serial_port_enable     ; 00BDh
    jmp os_sint_to_string         ; 00C0h
    jmp os_string_parse           ; 00C3h
    jmp __NOT_IMPLEMENTED__       ; os_run_basic              ; 00C6h
    jmp __NOT_IMPLEMENTED__       ; os_port_byte_out          ; 00C9h
    jmp __NOT_IMPLEMENTED__       ; os_port_byte_in           ; 00CCh
